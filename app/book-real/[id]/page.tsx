    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/test-books" className="text-purple-600 hover:underline">
            ← Back to Books
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white pb-32">
      ...
      <div className="bg-white shadow-sm py-6 mb-8">
        <div className="max-w-7xl mx-auto px-4">
          <Link href="/test-books" className="text-purple-600 hover:underline flex items-center gap-2">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          {book.chapters.length === 0 ? (
            ...
            <ChapterPlayer book={book} chapters={book.chapters} />
          )}
        </div>
      </div>
    </div>

    ...
    <div className="fixed bottom-0 left-0 right-0 bg-black border-t border-gray-800 px-2 sm:px-4 py-2 sm:py-3 z-50">
      ...
      <div className="block sm:hidden">
        ...
        <div 
          ...
          className="flex items-center gap-3 mb-3 cursor-pointer hover:bg-white/5 rounded-lg p-2 transition-colors"
        >
      ...
      {/* Desktop Layout */}
      <div className="hidden sm:block max-w-screen-2xl mx-auto">
